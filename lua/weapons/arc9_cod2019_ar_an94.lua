...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_xmags_up.ogg", t = 0.033},
			{s = path .. "wfoly_ar_anovember94_reload_xmags_magout.ogg", t = 0.7},
			{s = path .. "wfoly_ar_anovember94_reload_xmags_arm.ogg", t = 0.9},
			{s = path .. "wfoly_ar_anovember94_reload_xmag_magin_01.ogg", t = 1.3},
			{s = path .. "wfoly_ar_anovember94_reload_xmag_magin_02.ogg", t = 1.633},
			{s = path .. "wfoly_ar_anovember94_reload_xmags_mvmnt.ogg", t = 1.767},
			{s = path .. "wfoly_ar_anovember94_reload_xmags_end.ogg", t = 2.233},
			{hide = 1, t = 0},
			{hide = 0, t = 0.4},
			{hide = 2, t = 2},
			{hide = 1, t = 2.433},
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_up.ogg", t = 0.0},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_arm.ogg", t = 0.433},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_magout.ogg", t = 0.8},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_magin_01.ogg", t = 1.367},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_magin_02.ogg", t = 1.6},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_boltpull.ogg", t = 1.95},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_boltforward.ogg", t = 2.11},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmags_end.ogg", t = 2.133},
			{hide = 1, t = 0},
			{hide = 0, t = 0.433},
			{hide = 2, t = 1.3},
			{hide = 1, t = 2.633},	
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmags_up.ogg", t = 0.0},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmags_magout.ogg", t = 0.5},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmags_magin_01.ogg", t = 0.933},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmags_magin_02.ogg", t = 1.167},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmags_end.ogg", t = 1.5},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.9},
			{hide = 1, t = 1.66},
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_up.ogg", t = 0.0},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_arm.ogg", t = 0.367},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_magout.ogg", t = 0.533},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_magin_01.ogg", t = 0.967},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_magin_02.ogg", t = 1.167},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_boltpull.ogg", t = 1.467},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_boltforward.ogg", t = 1.667},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmags_end.ogg", t = 1.833},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.9},
			{hide = 1, t = 2.06},
    ...
    ["reload_xmagslrg"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_xmagslrg_up.ogg", t = 0.133},
			{s = path .. "wfoly_ar_anovember94_reload_xmagslrg_magout.ogg", t = 0.367},
			{s = path .. "wfoly_ar_anovember94_reload_xmagslrg_arm.ogg", t = 0.633},
			{s = path .. "wfoly_ar_anovember94_reload_xmagslrg_armup.ogg", t = 1.067},
			{s = path .. "wfoly_ar_anovember94_reload_xmaglrg_magin_01.ogg", t = 1.4},
			{s = path .. "wfoly_ar_anovember94_reload_xmaglrg_magin_02.ogg", t = 1.633},
			{s = path .. "wfoly_ar_anovember94_reload_xmagslrg_end.ogg", t = 2.067},
			{hide = 1, t = 0},
			{hide = 3, t = 0.8},
			{hide = 1, t = 1.05},
        },
    ...
    ["reload_xmagslrg_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_up.ogg", t = 0.0},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_arm.ogg", t = 0.767},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_magout.ogg", t = 0.867},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_magin_01.ogg", t = 1.3},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_magin_02.ogg", t = 1.533},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_boltpull.ogg", t = 1.867},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_boltforward.ogg", t = 2.067},
			{s = path .. "wfoly_ar_anovember94_reload_empty_xmagslrg_end.ogg", t = 2.467},
			{hide = 1, t = 0},
			{hide = 0, t = 0.433},
			{hide = 2, t = 1.3},
			{hide = 1, t = 2.633},	
    ...
    ["reload_xmagslrg_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmagslrg_up.ogg", t = 0.033},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmagslrg_magout.ogg", t = 0.5},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmagslrg_magin_01.ogg", t = 0.9},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmagslrg_magin_02.ogg", t = 1.1},
			{s = path .. "wfoly_ar_anovember94_reload_fast_xmagslrg_end.ogg", t = 1.467},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.9},
			{hide = 1, t = 1.66},
    ...
    ["reload_xmagslrg_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_up.ogg", t = 0.1},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_arm.ogg", t = 0.3},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_magout.ogg", t = 0.5},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_magin_01.ogg", t = 0.933},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_magin_02.ogg", t = 1.167},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_boltpull.ogg", t = 1.367},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_boltforward.ogg", t = 1.533},
			{s = path .. "wfoly_ar_anovember94_reload_empty_fast_xmagslrg_end.ogg", t = 1.9},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.9},
			{hide = 1, t = 2.06},
...
SWEP.Attachments = {
    { -- 1
        ...
        Category = {"cod2019_muzzle","cod2019_an94_muzzle"},
