...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2, 1, -1.5),
}
...
SWEP.CustomizePos = Vector(16, 45, 3)
...
SWEP.TriggerDownSound = path .. "weap_falima_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_falima_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_plr_ar_falima_reload_xmag_start.ogg", t = 4/30},
            {s = path .. "wfoly_plr_ar_falima_reload_xmag_magout_01.ogg", t = 18/30},
			{s = path .. "wfoly_plr_ar_falima_reload_xmag_rattle.ogg", t = 24/30},
			{s = path .. "wfoly_plr_ar_falima_reload_xmag_magin_v2_01.ogg", t = 41/30},
			{s = path .. "wfoly_plr_ar_falima_reload_xmag_magin_v2_02.ogg", t = 53/30},
			{s = path .. "wfoly_plr_ar_falima_reload_xmag_end.ogg", t = 67/30},
			{hide = 2, t = 0},
			{hide = 0, t = 0.25},
			{hide = 1, t = 2.3},
        },
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_rotate.ogg", t = 13/30},
            {s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_magout_01.ogg", t = 24/30},
            {s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_dropmag.ogg", t = 30/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_arm.ogg", t = 50/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_magin_v2_01.ogg", t = 55/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_magin_v2_02.ogg", t = 64/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_rattle.ogg", t = 73/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_charge_01.ogg", t = 81/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_xmag_end.ogg", t = 92/30},
			{hide = 1, t = 0},
			{hide = 3, t = 1.45},
			{hide = 1, t = 1.6},
        },
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_plr_ar_falima_reload_fast_xmag_magout_01.ogg", t = 7/30},
			{s = path .. "wfoly_plr_ar_falima_reload_fast_xmag_rattle.ogg", t = 8/30},
			{s = path .. "wfoly_plr_ar_falima_reload_fast_xmag_magin_v2_01.ogg", t = 22/30},
			{s = path .. "wfoly_plr_ar_falima_reload_fast_xmag_magin_v2_02.ogg", t = 37/30},
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_start.ogg", t = 0/30},
            {s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_rotate.ogg", t = 13/30},
            {s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_magout_01.ogg", t = 22/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_dropmag.ogg", t = 29/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_magin_v2_01.ogg", t = 50/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_magin_v2_02.ogg", t = 56/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_charge_01.ogg", t = 64/30},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_xmag_end.ogg", t = 70/30},
			{hide = 1, t = 0},
			{hide = 3, t = 1.375},
			{hide = 1, t = 1.5},
        },
...
-- UBGL Animations
    ...
    ["reload_fast_ubgl"] = {
		...
		EventTable = {
            ...
            {s = pathub .. "ubgl_reload_shellin_01.ogg", t = 14/30},
