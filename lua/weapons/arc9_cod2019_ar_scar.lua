...
SWEP.CustomizeRotateAnchor = Vector(16, -2.75, -4)
...
SWEP.Animations = {
    ...
    ["reload_dmr"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_scharlie_reload_dmr_rotate.ogg", t = 5/30},
			{s = path .. "wfoly_ar_scharlie_reload_dmr_magout.ogg", t = 21/30},
			{s = path .. "wfoly_ar_scharlie_reload_dmr_magin_v2_01.ogg", t = 31/30},
			{s = path .. "wfoly_ar_scharlie_reload_dmr_magin_v2_02.ogg", t = 43/30},
			{s = path .. "wfoly_ar_scharlie_reload_dmr_down.ogg", t = 44/30},
			{s = path .. "wfoly_ar_scharlie_reload_dmr_end.ogg", t = 64/30},
			{hide = 3, t = 0},
			{hide = 2, t = 0.15},
			{hide = 0, t = 0.4},
			{hide = 1, t = 1.7},
    ...
    ["reload_dmr_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_scharlie_reload_empty_dmr_rotate.ogg", t = 3/30},
			{s = path .. "wfoly_ar_scharlie_reload_empty_dmr_magout.ogg", t = 18/30},
			{s = path .. "wfoly_ar_scharlie_reload_empty_dmr_magin_v2_01.ogg", t = 45/30},
			{s = path .. "wfoly_ar_scharlie_reload_empty_dmr_magin_v2_02.ogg", t = 53/30},
			{s = path .. "wfoly_ar_scharlie_reload_empty_dmr_bolt_release.ogg", t = 65/30},
			{s = path .. "wfoly_ar_scharlie_reload_empty_dmr_end.ogg", t = 72/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.9},
			{hide = 1, t = 1.1},
        },
    ...
    ["reload_dmr_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_scharlie_reload_fast_dmr_magout.ogg", t = 1/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_dmr_magin_v2_01.ogg", t = 22/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_dmr_magin_v2_02.ogg", t = 31/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_dmr_end.ogg", t = 41/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.45},
			{hide = 1, t = 0.6},
        },
    ...
    ["reload_dmr_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_scharlie_reload_fast_empty_dmr_shake.ogg", t = 1/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_empty_dmr_magout.ogg", t = 6/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_empty_dmr_magin_v2_01.ogg", t = 26/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_empty_dmr_magin_v2_02.ogg", t = 31/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_empty_dmr_bolt_release.ogg", t = 42/30},
			{s = path .. "wfoly_ar_scharlie_reload_fast_empty_dmr_end.ogg", t = 43/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.45},
			{hide = 1, t = 0.6},
        },
