...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(3, 1, -2),
}
...
SWEP.CustomizePos = Vector(15.5, 42.5, 3)
SWEP.CustomizeRotateAnchor = Vector(15.5, -2.25, -4)
...
SWEP.TriggerDownSound = path .. "weap_sksierra_hammer_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_sksierra_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_magin_01.ogg", t = 0.95},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_magin_02.ogg", t = 1.15},
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_xmag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_xmag_magout.ogg", t = 0.7},
			{s = path .. "wfoly_sn_sksierra_reload_xmag_magin_01.ogg", t = 1.067},
			{s = path .. "wfoly_sn_sksierra_reload_xmag_magin_02.ogg", t = 1.533},
			{s = path .. "wfoly_sn_sksierra_reload_xmag_end.ogg", t = 2.133},
			{hide = 1, t = 0},
			{hide = 0, t = 0.366},
			{hide = 2, t = 2.133},
			{hide = 1, t = 2.566},
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_empty_xmag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_empty_xmag_magout.ogg", t = 0.7},
			{s = path .. "wfoly_sn_sksierra_reload_empty_xmag_magin_01.ogg", t = 1.233},
			{s = path .. "wfoly_sn_sksierra_reload_empty_xmag_magin_02.ogg", t = 1.4},
			{s = path .. "wfoly_sn_sksierra_reload_empty_xmag_rotate.ogg", t = 1.6},
			{s = path .. "wfoly_sn_sksierra_reload_empty_xmag_charge.ogg", t = 2.15},
			{s = path .. "wfoly_sn_sksierra_reload_empty_xmag_end.ogg", t = 2.767},
			{hide = 1, t = 0},
			{hide = 0, t = 0.366},
			{hide = 2, t = 1.1},
			{hide = 1, t = 1.833},
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_fast_xmag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_fast_xmag_magout.ogg", t = 0.533},
			{s = path .. "wfoly_sn_sksierra_reload_fast_xmag_magin_01.ogg", t = 1.057},
			{s = path .. "wfoly_sn_sksierra_reload_fast_xmag_magin_02.ogg", t = 1.18},
			{s = path .. "wfoly_sn_sksierra_reload_fast_xmag_end.ogg", t = 1.567},
			{hide = 1, t = 0},
			{hide = 0, t = 0.2},
			{hide = 2, t = 1},
			{hide = 1, t = 1.7},
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_raise.ogg", t = 0.033},
            {s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_magout.ogg", t = 0.467},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_magin_01.ogg", t = 0.967},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_magin_02.ogg", t = 1.167},
            {s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_mvmnt.ogg", t = 1.2},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_charge.ogg", t = 1.633},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_xmag_end.ogg", t = 1.933},
			{hide = 1, t = 0},
			{hide = 0, t = 0.233},
			{hide = 2, t = 1},
			{hide = 1, t = 2.2},
    ...
    ["reload_smag"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_smag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_smag_magout.ogg", t = 0.3},
			{s = path .. "wfoly_sn_sksierra_reload_smag_magin_01.ogg", t = 1.167},
			{s = path .. "wfoly_sn_sksierra_reload_smag_magin_02.ogg", t = 1.5},
			{s = path .. "wfoly_sn_sksierra_reload_smag_end.ogg", t = 1.833},
			{hide = 1, t = 0},
			{hide = 3, t = 0.45},
			{hide = 1, t = 0.75},
        },
    ...
    ["reload_smag_empty"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_empty_smag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_empty_smag_magout.ogg", t = 0.7},
			{s = path .. "wfoly_sn_sksierra_reload_empty_smag_magin_01.ogg", t = 1.2},
			{s = path .. "wfoly_sn_sksierra_reload_empty_smag_magin_02.ogg", t = 1.4},
			{s = path .. "wfoly_sn_sksierra_reload_empty_smag_rotate.ogg", t = 1.4},
			{s = path .. "wfoly_sn_sksierra_reload_empty_smag_charge.ogg", t = 2.067},
			{s = path .. "wfoly_sn_sksierra_reload_empty_smag_end.ogg", t = 2.567},
			{hide = 1, t = 0},
			{hide = 0, t = 0.366},
			{hide = 2, t = 1.1},
			{hide = 1, t = 1.833},
    ...
    ["reload_smag_fast"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_fast_smag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_fast_smag_magout.ogg", t = 0.433},
			{s = path .. "wfoly_sn_sksierra_reload_fast_smag_magin_01.ogg", t = 0.833},
			{s = path .. "wfoly_sn_sksierra_reload_fast_smag_magin_02.ogg", t = 1.033},
			{s = path .. "wfoly_sn_sksierra_reload_fast_smag_end.ogg", t = 1.4},
			{hide = 1, t = 0},
			{hide = 0, t = 0.166},
			{hide = 2, t = 1},
			{hide = 1, t = 1.466},
    ...
    ["reload_smag_fast_empty"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_sksierra_reload_empty_fast_smag_raise.ogg", t = 0.0},
            {s = path .. "wfoly_sn_sksierra_reload_empty_fast_smag_magout.ogg", t = 0.567},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_smag_magin_01.ogg", t = 1.0},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_smag_magin_02.ogg", t = 1.2},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_smag_charge.ogg", t = 1.433},
			{s = path .. "wfoly_sn_sksierra_reload_empty_fast_smag_end.ogg", t = 1.833},
			{hide = 1, t = 0},
			{hide = 0, t = 0.2},
			{hide = 2, t = 0.9},
			{hide = 1, t = 2.133},
