...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2, 0.5, -4),
}
...
SWEP.CustomizeSnapshotPos = Vector(0.5, 5, -0.5)
...
SWEP.TriggerDownSound = path .. "weap_papa320_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_papa320_disconnector_plr_01.ogg"
