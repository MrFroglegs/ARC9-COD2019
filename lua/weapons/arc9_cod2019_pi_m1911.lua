...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2, 0, -4),
}
...
SWEP.CustomizePos = Vector(15, 30, 4.25)
...
SWEP.PeekPos = Vector(-3.5, -5, -2)
SWEP.PeekAng = Angle(0, 0, -55)

SWEP.PeekPosReloading = Vector(-1, -1, -1)
...
SWEP.TriggerDownSound = path .. "weap_mike1911_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_mike1911_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_pi_mike1911_reload_empty_magin_v2_01.ogg", t = 20/30},
			{s = path .. "wfoly_pi_mike1911_reload_empty_magin_v2_02.ogg", t = 26/30},
            {s = path .. "wfoly_pi_mike1911_reload_empty_end.ogg", t = 33/30},
			{s = path .. "wfoly_pi_mike1911_reload_empty_chamber_01.ogg", t = 35/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.45}
        },
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_pi_mike1911_fast_reload_empty_end.ogg", t = 14/30},
...
SWEP.Attachments = {
    ...
    { -- 18
		...
		Icon_Offset = Vector(-4, 0.05, 2.325),
		CosmeticOnly = true,
