...
SWEP.TriggerDownSound = path .. "weap_golf21_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_golf21_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_pi_golf21_reload_empty_magout_01.ogg", t = 0/30},
            {s = path .. "wfoly_pi_golf21_reload_empty_raise.ogg", t = 2/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_magin_v2_01.ogg", t = 18/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_magin_v2_02.ogg", t = 25/30},
            {s = path .. "wfoly_pi_golf21_reload_empty_down.ogg", t = 30/30},
    ...
    ["reload_xmaglrg_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_pi_golf21_reload_empty_magout_01.ogg", t = 0/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_down.ogg", t = 2/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_magin_v2_01.ogg", t = 18/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_magin_v2_02.ogg", t = 25/30},
