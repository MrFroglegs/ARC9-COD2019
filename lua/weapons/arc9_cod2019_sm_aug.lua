...
SWEP.Animations = {
	...
	["reload_xmag"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_magout_01.ogg", t = 0.533},
			{s = path .. "wfoly_sm_augolf_reload_magin_cloth.ogg", t = 1.033},
			{s = path .. "wfoly_sm_augolf_reload_magin_v2_01.ogg", t = 1.3},
			{s = path .. "wfoly_sm_augolf_reload_magin_v2_02.ogg", t = 1.6},
			{s = path .. "wfoly_sm_augolf_reload_lower.ogg", t = 1.533},
			{s = path .. "wfoly_sm_augolf_reload_end.ogg", t = 1.933},
			{hide = 1, t = 0},
			{hide = 2, t = 0.65},
	...
	["reload_empty_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_augolf_reload_empty_mvmnt.ogg", t = 0.067},
			{s = path .. "wfoly_sm_augolf_reload_empty_boltopen.ogg", t = 0.333},
			{s = path .. "wfoly_sm_augolf_reload_empty_magout_01.ogg", t = 0.933},
			{s = path .. "wfoly_sm_augolf_reload_empty_magoutcloth.ogg", t = 1.233},
			{s = path .. "wfoly_sm_augolf_reload_empty_magincloth.ogg", t = 1.8},
			{s = path .. "wfoly_sm_augolf_reload_empty_magin_v2_01.ogg", t = 1.953},
			{s = path .. "wfoly_sm_augolf_reload_empty_magin_v2_02.ogg", t = 2.087},
			{s = path .. "wfoly_sm_augolf_reload_empty_chamber_01.ogg", t = 2.55},
			{s = path .. "wfoly_sm_augolf_reload_empty_end.ogg", t = 2.6},
			{hide = 1, t = 0},
			{hide = 2, t = 1.25},
			{hide = 1, t = 1.6},
		},
    ...
    ["reload_drummag"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_drum_magin_v2_01.ogg", t = 40/30},
			{s = path .. "wfoly_sm_augolf_reload_drum_magin_v2_02.ogg", t = 46/30},
