...
SWEP.RangeMin = 14 / ARC9.HUToM -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 34 / ARC9.HUToM -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.CustomizeRotateAnchor = Vector(12, -2.75, -4)
...
SWEP.TriggerDownSound = path .. "weap_beta_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_beta_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_sm_beta_reload_empty_end.ogg", t = 2.1},
			{hide = 1, t = 0},
			{hide = 2, t = 0.7},
			{hide = 1, t = 1},
        },
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_end.ogg", t = 1.55},
			{hide = 1, t = 0},
			{hide = 2, t = 0.6},
			{hide = 1, t = 0.725},
        },
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_sm_beta_reload_magout_01.ogg", t = 7.5/30},
			{s = path .. "wfoly_plr_sm_beta_reload_magin_v2_01.ogg", t = 35/30},
			{s = path .. "wfoly_plr_sm_beta_reload_magin_v2_02.ogg", t = 49.5/30},
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_sm_beta_reload_empty_end.ogg", t = 66.5/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.7},
			{hide = 1, t = 1},
        },
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_start.ogg", t = 0.0},
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_magout_01.ogg", t = 0.25},
            {s = path .. "wfoly_plr_sm_beta_reload_empty_fast_rotate.ogg", t = 0.7},
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_magin_v2_01.ogg", t = 0.813},
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_magin_v2_02.ogg", t = 1.14},
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_charge_01.ogg", t = 1.45},
			{s = path .. "wfoly_plr_sm_beta_reload_empty_fast_end.ogg", t = 1.55},
			{hide = 1, t = 0},
			{hide = 2, t = 0.6},
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_plr_sm_beta_raise_first_charge.ogg", t = 0.45},
			{s = path .. "wfoly_plr_sm_beta_raise_first_end.ogg", t = 1},
        },
    },
    ["draw"] = {
        Source = "draw_short",
