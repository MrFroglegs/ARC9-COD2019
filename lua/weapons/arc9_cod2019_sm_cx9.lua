...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(3.5, 0.5, -2.5),
}
...
SWEP.CustomizePos = Vector(8.75, 35, 3)
SWEP.CustomizeRotateAnchor = Vector(8.75, -2.25, -4)
SWEP.CustomizeSnapshotFOV = 65
SWEP.CustomizeSnapshotPos = Vector(0, 27.5, 0)
...
SWEP.TriggerUpSound = path .. "weap_secho_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_smag"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sm_secho_reload_smag_up.ogg", t = 0.0},
            {s = path .. "wfoly_sm_secho_reload_smag_magout.ogg", t = 0.633},
			{s = path .. "wfoly_sm_secho_reload_smag_maghit.ogg", t = 0.967},
			{s = path .. "wfoly_sm_secho_reload_smag_magin.ogg", t = 1.1},
			{s = path .. "wfoly_sm_secho_reload_smag_end.ogg", t = 1.5},
			{hide = 1, t = 0},
			{hide = 0, t = 0.5},
			{hide = 2, t = 1.6},
			{hide = 1, t = 2.06},
    ...
    ["reload_empty_smag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_secho_reload_empty_smag_up.ogg", t = 0.0},
			{s = path .. "wfoly_sm_secho_reload_empty_smag_magout.ogg", t = 0.4},
			{s = path .. "wfoly_sm_secho_reload_empty_smag_mvmnt.ogg", t = 0.633},
			{s = path .. "wfoly_sm_secho_reload_empty_smag_maghit.ogg", t = 1.033},
			{s = path .. "wfoly_sm_secho_reload_empty_smag_magin.ogg", t = 1.233},
			{s = path .. "wfoly_sm_secho_reload_empty_smag_charge.ogg", t = 1.333},
			{s = path .. "wfoly_sm_secho_reload_empty_smag_end.ogg", t = 1.75},
			{hide = 1, t = 0},
			{hide = 2, t = 0.575},
			{hide = 0, t = 2},
			{hide = 1, t = 2.12},
    ...
    ["reload_fast_smag"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sm_secho_reload_fast_smag_up.ogg", t = 0.0},
            {s = path .. "wfoly_sm_secho_reload_fast_smag_magout.ogg", t = 0.133},
			{s = path .. "wfoly_sm_secho_reload_fast_smag_mvmnt.ogg", t = 0.333},
            {s = path .. "wfoly_sm_secho_reload_fast_smag_maghit.ogg", t = 0.467},
            {s = path .. "wfoly_sm_secho_reload_fast_smag_magin.ogg", t = 0.667},
            {s = path .. "wfoly_sm_secho_reload_fast_smag_end.ogg", t = 0.867},
			{hide = 1, t = 0},
			{hide = 2, t = 0.375},
			{hide = 1, t = 1.116},
        },
    ...
    ["reload_empty_smag_fast"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sm_secho_reload_empty_fast_smag_magout.ogg", t = 0.0},
            {s = path .. "wfoly_sm_secho_reload_empty_fast_smag_mvmnt.ogg", t = 0.333},
			{s = path .. "wfoly_sm_secho_reload_empty_fast_smag_magin.ogg", t = 0.6},
			{s = path .. "wfoly_sm_secho_reload_empty_fast_smag_charge.ogg", t = 0.933},
			{s = path .. "wfoly_sm_secho_reload_empty_fast_smag_end.ogg", t = 0.967},
			{hide = 1, t = 0},
			{hide = 2, t = 0.375},
			{hide = 1, t = 1.416},
        },
    ...
    ["inspect_smag"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sm_secho_inspect_smag_magout.ogg", t = 0.1},
			{s = path .. "wfoly_sm_secho_inspect_smag_magin.ogg", t = 1.867},
			{s = path .. "wfoly_sm_secho_inspect_smag_end.ogg", t = 3.5},
        },
    },
    ["inspect_drum"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sm_secho_inspect_drum_drumout.ogg", t = 0.067},
			{s = path .. "wfoly_sm_secho_inspect_drum_drumin.ogg", t = 1.8},
			{s = path .. "wfoly_sm_secho_inspect_drum_end.ogg", t = 4.0},
        },
    },
    ["bash"] = {
...
local Translate_SMag = {
    ["reload"] = "reload_smag",
    ["reload_empty"] = "reload_empty_smag",
