...
SWEP.WorldModel = "models/weapons/cod2019/w_smg_iso.mdl"
...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(3, 0.5, -1.5),
}
...
SWEP.RangeMin = 17 / ARC9.HUToM -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 32 / ARC9.HUToM -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.SpreadAddSights = -SWEP.Spread * 1.1
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_charlie9_first_raise_bolt_forward.ogg", t = 0.45},
...
SWEP.Attachments = {
    ...
    { -- 9
        ...
        Category = "cod2019_iso_pistolgrip",
