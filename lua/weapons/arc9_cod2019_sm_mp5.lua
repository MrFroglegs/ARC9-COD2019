...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2.5, 0.75, -2),
}
...
SWEP.RangeMin = 11 / ARC9.HUToM -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 27 / ARC9.HUToM -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.CustomizeRotateAnchor = Vector(13.5, -3.5, -4)
...
SWEP.TriggerDownSound = path .. "weap_mpapa5_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_mpapa5_disconnector_plr_01.ogg"
