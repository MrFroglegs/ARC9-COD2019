...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2, 0.75, -2.5),
}
...
SWEP.RangeMin = 22 / ARC9.HUToM -- How far bullets retain their maximum damage for.
...
SWEP.CustomizePos = Vector(10.5, 35, 4.5)
SWEP.CustomizeRotateAnchor = Vector(10.5, -3, -4)
SWEP.CustomizeSnapshotFOV = 65
SWEP.CustomizeSnapshotPos = Vector(0, 42.5, 1.5)
...
SWEP.Animations = {
    ...
    ["reload_smag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_smgolf45_reload_smag_raise.ogg", t = 0.0},
			{s = path .. "wfoly_sm_smgolf45_reload_smag_magout.ogg", t = 0.633},
    ...
    ["reload_smag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_smgolf45_reload_empty_smag_raise.ogg", t = 0.033},
			{s = path .. "wfoly_sm_smgolf45_reload_empty_smag_magout.ogg", t = 0.267},
            {s = path .. "wfoly_sm_smgolf45_reload_empty_smag_maghit.ogg", t = 1.10},
    ...
    ["reload_smag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_smgolf45_reload_fast_smag_raise.ogg", t = 0.0},
    ...
    ["reload_smag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_smgolf45_reload_empty_fast_smag_raise.ogg", t = 0.033},
			{s = path .. "wfoly_sm_smgolf45_reload_empty_fast_smag_magout.ogg", t = 0.367},
