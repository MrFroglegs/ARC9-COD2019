...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(1.5, 2.5, -1),
}
...
SWEP.RangeMax = 36 / ARC9.HUToM -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.Animations = {
    ...
    ["reload_xmag2"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_sm_uzulu_reload_magin_01.ogg", t = 43/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_shake.ogg", t = 46/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_end.ogg", t = 59/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.6},
			{hide = 1, t = 2.16},
        },
    ...
    ["reload_xmag2_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_magout_01.ogg", t = 13/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_tilt.ogg", t = 13/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_magin_01.ogg", t = 36/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_charge_01.ogg", t = 69/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_arm.ogg", t = 60/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_rattle.ogg", t = 82/30},
			{s = path .. "wfoly_plr_sm_uzulu_reload_empty_end.ogg", t = 82/30},
