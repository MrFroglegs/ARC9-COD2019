...
SWEP.WorldModel = "models/weapons/cod2019/w_smg_vector.mdl"
...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2.5, 0.25, -1.5),
}
...
SWEP.CustomizePos = Vector(9.25, 32.5, 4.5)
SWEP.CustomizeRotateAnchor = Vector(9.25, -2.5, -4.5)
SWEP.CustomizeSnapshotFOV = 65
SWEP.CustomizeSnapshotPos = Vector(-1, 30, -0.5)
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_victor_raise_first_charge.ogg", t = 0.25},
			{s = path .. "wfoly_sm_victor_raise_first_end.ogg", t = 0.75},
        },
    },
    ["draw"] = {
        Source = "draw_short",
